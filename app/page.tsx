...
export default function DashboardPage() {
  ...
  return (
    <main className="flex min-h-screen w-full flex-col bg-neutral-100 pt-10 pb-20 text-neutral-900 sm:pt-20">
      <div className="mx-auto w-full flex-col gap-10 px-6 pb-20 text-neutral-900 sm:max-w-2xl lg:max-w-5xl lg:px-10 xl:max-w-6xl">
        <header>
