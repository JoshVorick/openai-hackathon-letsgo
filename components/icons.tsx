export const BellhopMark = ({ className }: { className?: string }) => {
  return (
    <svg
      className={className}
      fill="currentColor"
    ...
    >
      <path d="M1.90766 28C0.803954 28 -0.101133 27.103 0.00911313 26.0048C0.203726 24.0663 0.681313 22.1629 1.42965 20.3563C2.43344 17.9329 3.90471 15.731 5.75947 13.8762C7.61422 12.0215 9.81614 10.5502 12.2395 9.54642C14.6629 8.54263 17.2602 8.02599 19.8832 8.02599C22.5062 8.02599 25.1036 8.54264 27.5269 9.54642C29.9503 10.5502 32.1522 12.0215 34.0069 13.8762C35.8617 15.731 37.333 17.9329 38.3368 20.3563C39.0851 22.1629 39.5627 24.0663 39.7573 26.0049C39.8675 27.103 38.9625 28 37.8587 28C36.755 28 35.8732 27.1018 35.7355 26.0067C35.5578 24.5935 35.1915 23.2073 34.6441 21.8858C33.8412 19.9474 32.6643 18.1861 31.1807 16.7025C29.6971 15.2189 27.9358 14.042 25.9974 13.2391C24.0589 12.4361 21.9813 12.0229 19.8832 12.0229C17.7851 12.0229 15.7075 12.4361 13.769 13.2391C11.8306 14.042 10.0693 15.2188 8.58569 16.7025C7.10208 18.1861 5.92521 19.9474 5.12229 21.8858C4.57491 23.2073 4.20863 24.5935 4.03093 26.0067C3.89323 27.1018 3.01137 28 1.90766 28Z" />
      <path d="M16.1442 4.01302C16.1442 3.48602 16.2409 2.96418 16.4289 2.47729C16.6168 1.99041 16.8922 1.54802 17.2395 1.17537C17.5867 0.802726 17.9989 0.507128 18.4526 0.305454C18.9063 0.10378 19.3926 -2.042e-05 19.8836 -2.03541e-05C20.3747 -2.02881e-05 20.861 0.10378 21.3146 0.305454C21.7683 0.507128 22.1806 0.802726 22.5278 1.17537C22.875 1.54802 23.1505 1.99041 23.3384 2.47729C23.5263 2.96418 23.623 3.48602 23.623 4.01302L19.8836 4.01302L16.1442 4.01302Z" />
    </svg>
  );
};
